...
export default function CartPage() {
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#0a0a0c', color: '#e2e8f0', fontFamily: 'Outfit, Inter, sans-serif', padding: '40px 24px' }} className="storeCartPage">
            <div style={{ maxWidth: isOverlay ? 1100 : 1400, margin: '0 auto' }}>
                <button
                    onClick={() => router.back()}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: isOverlay ? '360px 360px 360px' : 'minmax(420px, 1.5fr) minmax(380px, 1.2fr) 420px', gap: isOverlay ? 24 : 40, justifyContent: isOverlay ? 'center' : 'stretch' }} className="storeCartGrid">
